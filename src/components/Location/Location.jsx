      ...
      <div className="max-sm:m-2 max-sm:p-2 flex justify-between m-5 p-5 gap-2">
        <div className="max-sm:gap-2 flex flex-col gap-5 ">
          <div className="text-[24px]">
            <div className="max-sm:text-[10px] font-syne">Alamat</div>
            <div className="max-sm:text-[8px] font-poppins text-[#7E587D]">
              Griya Bandung Asri 2 Blok C5 NO.5
              {LocationName}
            </div>
          </div>
          <div className="text-[24px]">
            <div className="max-sm:text-[10px] font-syne">No Telp</div>
            <div className="max-sm:text-[8px] font-poppins text-[#7E587D]">
              087738881510 {LocationPhoneNum}{" "}
            </div>
            <div className="max-sm:text-[7px] font-poppins text-[16px] text-[#7E587D]">
              {OpenAt}
              Buka setiap hari jam 08.00 - 18.00 wib
            </div>
          </div>
          <div>
            <div className="max-sm:text-[10px] font-syne text-[24px]">
              Titik Peta
            </div>
            <div>
              <iframe
